...
#eid_list = {'2-s2.0-84870874133'}
#eid_list = {'2-s2.0-84892951143'}
#eid_list = {'2-s2.0-84892757818'}
#eid_list = ['2-s2.0-84875020851']
#eid_list = ['2-s2.0-0037070197']
#eid_list = ['2-s2.0-84893613312']
#eid_list = ['2-s2.0-84903170614']
...
for eid in eid_list:
    ...
    # Print number of articles left
    #print 'Number of articles remaining:', len(eid_list)-eid_list.index(eid)
        ...
        for cw in article['citing_works'].iteritems():
            ...
            for auth in cw[1]['article_authors'].iteritems():
                ...
                article_csv.writerow([article.get('article_eid', ''),
                                      ...
                                      cw[1].get('journal_issn', ''),
                                      cw[1].get('journal_ipp', ''),
